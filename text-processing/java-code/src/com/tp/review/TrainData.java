...
public class TrainData extends Base {
  
  static Logger logger = Logger.getLogger(TrainData.class);
  ...
  public String processRecord(String record) {
    ...
    try {
      ...
      line += "\"age\"" + ": " + String.valueOf((getStartDate("2013-01-19").getTime() - end.getTime()) / (24 * 60 * 60 * 1000)) + ", ";
    ...
    line += "\"useful_votes\": " + ((JSONObject) jsonObject.get("votes")).get("useful").toString() + ", ";
